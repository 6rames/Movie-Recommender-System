...
Link to the web application :- https://movie-recommender-app1.herokuapp.com/

Thanks for Prashant Jha. I replicated this app through below blog & github reference.
